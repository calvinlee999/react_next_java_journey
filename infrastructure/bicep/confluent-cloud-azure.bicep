...
// Confluent Cloud Organization Resource (Azure Marketplace)
resource confluentOrganization 'Microsoft.Confluent/organizations@2021-12-01' = {
  name: '${confluentServiceName}-org'
  location: location
  tags: commonTags
  properties: {
    offerDetail: {
      publisherId: 'confluentinc'
      id: 'confluent-cloud-azure-stag'
      planId: 'confluent-cloud-kafka-payg'
...
output confluentOrganizationName string = confluentOrganization.name
...
output eventHubsConnectionString string = listKeys(resourceId('Microsoft.EventHub/namespaces/authorizationRules', eventHubsNamespace.name, 'RootManageSharedAccessKey'), '2023-01-01-preview').primaryConnectionString
output logAnalyticsWorkspaceId string = logAnalyticsWorkspace.id

// Resource naming outputs for other templates
output resourceNames object = {
  confluentOrganization: confluentOrganization.name
