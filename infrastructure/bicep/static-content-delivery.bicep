...
var odataTypeCondition = 'Microsoft.Azure.Cdn.Models.DeliveryRuleUrlFileExtensionMatchConditionParameters'
var odataTypeAction = 'Microsoft.Azure.Cdn.Models.DeliveryRuleCacheExpirationActionParameters'
          ...
          conditions: [
            {
              ...
              parameters: {
                ...
                matchValues: ['css', 'js', 'png', 'jpg', 'jpeg', 'gif', 'svg', 'ico', 'woff', 'woff2', 'ttf']
              }
            }
          ]
          actions: [
          ...
          matchConditions: [
            {
              ...
              matchValue: ['US', 'CA', 'GB', 'DE', 'FR', 'JP', 'AU']
            }
          ]
          action: 'Block'
        }
